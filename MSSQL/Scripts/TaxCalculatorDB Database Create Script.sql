...
CREATE DATABASE [TaxCalculatorDB]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'TaxCalculatorDB', FILENAME = N'C:\MSSQL\TaxCalculatorDB.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'TaxCalculatorDB_log', FILENAME = N'C:\MSSQL\TaxCalculatorDB_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
...
ALTER DATABASE [TaxCalculatorDB] SET RECOVERY SIMPLE 
GO
